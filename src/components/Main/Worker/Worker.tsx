    ...
    <div className='worker'>
      ...
      <div className='worker__container-noIPR'>
        <div className='worker__wrapperImg-noIPR'>
          <img src={NoIpr} className='worker__noIpr' alt='иконка отсутствия ИПР' />
        </div>
        <h4 className='worker__title'>У сотрудника пока нет ИПР</h4>
        <p className='worker__subtitle'>Чтобы создать индивидуальный план развития сотрудника, нажмите «Создать ИПР»</p>
      </div>
    </div>
  )
}
